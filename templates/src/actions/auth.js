import { REGISTER_SUCCESS, REGISTER_FAILED, USER_LOADED, AUTH_ERROR, LOGIN_FAILED, LOGIN_SUCCESS } from '../actions/constants';
 ...
 */
export const registerAction = ({name, username, password, phone}) => async dispatch => {
    const config = {
        headers: {
